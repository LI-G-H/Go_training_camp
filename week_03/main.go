...
func StartHttpServer(srv *http.Server, handleFuc func(http.ResponseWriter, *http.Request)) error {
	http.HandleFunc("/hello", handleFuc)
	fmt.Println("http server start")
	err := srv.ListenAndServe()
	return err
}

// HelloServer2 增加一个 HTTP handler
